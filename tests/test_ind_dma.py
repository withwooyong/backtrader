...
# DMA 지표의 예상 값들 (30일 Displaced Moving Average)
# 각 값은 [시작점, 중간점, 끝점] 순서로 되어 있음
# DMA는 이동평균을 특정 기간만큼 앞으로 이동시킨 지표입니다
# 일반 이동평균보다 추세 변화에 더 빠르게 반응합니다
chkvals = [
    ['4121.903804', '3677.634675', '3579.962958']
]


# 지표의 최소 기간 (DMA의 경우 30일)
chkmin = 30

# 테스트할 지표 클래스 (Displaced Moving Average)
chkind = btind.DMA
